...
export default class ApiClient {
    ...
    getEntrypoint<T extends ApiEntrypoints = Entrypoint<any>>(entity: EntityType): T {
        switch (entity) {
            case EntityType.Building: return this.buildings as T;
            case EntityType.Cabinet: return this.cabinets as T;
            case EntityType.Group: return this.groups as T;
            case EntityType.Lesson: return this.lessons as T;
            case EntityType.PatchEntry: return this.patches as T;
            case EntityType.Teacher: return this.teachers as T;
            case EntityType.TimetableEntry: return this.timetable as T;
            default: throw new Error('no entrypoint for key ' + entity);
        }
    }
}
